...
class SQS:
    ...
    def receive_message(self, max_number_of_messages: int = 1) -> Dict:
        """
        Receive messages from the queue.
        Args:
            max_number_of_messages (int): The maximum number of messages to return.
            We should be careful with requesting more than one message because deleting
            a message from the queue is not atomic. If we request more than one message.
        Returns:
    ...
    def delete_message(self, receipt_handle: str) -> Dict:
        ...
        Args:
            ...
            This is different to the message id. The receipt handle represents
            the specific instance of receiving the message versus a single message.
        Returns:
